...
namespace UbyTecAPI.Migrations
{
    ...
    [Migration("20241112011208_AddTelefonoAfiliado")]
    partial class AddTelefonoAfiliado
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UbyTecAPI.Models.Afiliado", b =>
                {
                    b.HasOne("UbyTecAPI.Models.Administrador", "Administrador")
                        .WithMany()
                        .HasForeignKey("AdministradorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UbyTecAPI.Models.TipoComercio", "TipoComercio")
                        .WithMany("Afiliados")
